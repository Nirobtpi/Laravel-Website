...
<div class="container-fluid">
    <div class="block-header">
        <a href="{{ route('admin.tag.create') }}" class="btn btn-primary"><i class="material-icons">add</i><span>Add New
                Tag</span></a>
    </div>
    <!-- Exportable Table -->
